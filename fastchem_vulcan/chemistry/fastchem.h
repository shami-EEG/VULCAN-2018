...
//Physical constants
const double CONST_K = 1.3806504e-16;    //Boltzmann constant
...
class FastChem{
  ...
  private:
    ...
    unsigned int nb_max_neldermead_iter = 1000;
    ...
    void intertSol(Element<double_type>& species, const double_type h_density, const unsigned int grid_index);
